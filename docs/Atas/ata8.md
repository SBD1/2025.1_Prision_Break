...
- Revisão e correção da modelagem
- Revisão e correção da documentação da entrega 2

<p align="center"><strong>Tabela 3:</strong> Atividade a ser desenvolvida</p>

*Não houve divisão de tarefas pois todas as atividade da entrega foram finalizadas, ficando pendente apenas a gravação do vídeo de apresentação*
...
| :----: | :--------: | :-------: | :-----------------------------: |
| `1.0`  | 15/06/2025 |   Criação da Ata da Reunião    | [Maria Alice](https://github.com/Maliz30) |
